...
public class GamePanel extends JPanel implements Runnable
{
	 ...
	 * 
	 * @return	Returns a org.games.vertigo.Level object corresponding to the current level
	 */
	 ...
	 * 
	 * @return	Returns a org.games.vertigo.Player object referring to the player
	 */
	 ...
	 * 
	 * @return	Returns an ArrayList of org.games.vertigo.Sprite objects referring to the sprites
	...
	public void paintComponent(Graphics g)
	{
		...
		switch (GameState.getCurrentState())
		{
			...
			case GameState.CONTROLS:
				...
				drawString(g, "Fire org.games.vertigo.Missile", daysLaterFont, gray, 48, 108,
					415);
				
				g.drawImage(controlKey, 100, 460, null);
				drawString(g, "Fire org.games.vertigo.Bomb", daysLaterFont, gray, 48, 110, 505);
				
				g.drawImage(pKey, 113, 550, null);
				drawString(g, "Pause org.games.vertigo.Game", daysLaterFont, gray, 48, 108, 595);
			...
			case GameState.LEVEL_COMPLETE:
				...
				drawString(g, "org.games.vertigo.Level Score", daysLaterFont, gray, 48, 300);
			...
			case GameState.CREDITS:
				...
				drawString(g, "Music and org.games.vertigo.Sound Effects", ankFont, gray, 28, 1100
					- creditScroll);
	 ...
	 * the org.games.vertigo.KeyboardEvent class because things needs to happen just after the key
	 * is pressed).
	 * 
